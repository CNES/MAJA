    ...
    if split == 'ncks':
        ...
        if file_type['surface'] == True:
            ...
            for i in range(nb_days):
                ...
                #Split into daily file
                cmd = 'ncks -O -d time,'+daySplit+','+daySplit+' '+OutNames['surface']+' '+OutNames['surface'].replace(month,daySaved)
                os.system(cmd)
        ...
        if file_type['pressure'] == True:
            ...
            for i in range(nb_days):
                ...
                #Split into daily file
                cmd = 'ncks -O -d time,'+daySplit+','+daySplit+' '+OutNames['pressure']+' '+OutNames['pressure'].replace(month,daySaved)
                os.system(cmd)
        ...
        if file_type['model'] == True:
            ...
            for i in range(nb_days):
                ...
                #Split into daily file
                cmd = 'ncks -O -d time,'+daySplit+','+daySplit+' '+OutNames['model']+' '+OutNames['model'].replace(month,daySaved)
                os.system(cmd)
...
if mode=="daily":
    for i in range(nb_days):
        ...
        for t in range(len(time)):
            (nom_AOT,nom_RH,nom_MR)=download_files(request_date,file_type,time[t],step,path_out)
