...
class MajaLandsat8MuscatePlugin(PluginBase):
    """
    classdocs
    """

    def __init__(self):
        super(MajaLandsat8MuscatePlugin, self).__init__()
        self.PluginName = "LANDSAT8_MUSCATE"
        self.UniqueSatellite = "LANDSAT8"
        self.ShortFileType = "L8C"
        self.ListOfSatellites.append("LANDSAT8")
        self.QCK_PREFIX_MAP["LANDSAT8"] = "L8"
        ...
        self.L2RejectedBands.append("B8")
        self.L2RejectedBands.append("B9")
        self.L2RejectedBands.append("B10")
        self.L2RejectedBands.append("B11")

        # Schemas install dir
        self.MAJA_INSTALL_SCHEMAS_DIR = "LANDSAT8_MUSCATE"

        # Private Templates
        self.TEMPLATE_PDTANX_PRIVATE_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/JPI_ALL.xml"

        self.TEMPLATE_PDTANX_PRIVATE_LTC_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_LTC.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_NDT_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_NDT.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_WAM_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_WAM.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_CLD_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_CLD.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_CLA_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_CLA.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_PWD_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_PWD.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_RCR_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_RCR.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_RTA_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_RTA.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_RTC_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_RTC.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_STO_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_STO.HDR"
        self.TEMPLATE_PDTANX_PRIVATE_PXD_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/PDTANX_PRIVATE_PXD.HDR"

        self.TEMPLATE_TEC_PRIVATE_EEF = "LANDSAT8_MUSCATE/Templates/L2.product/TEC_PRIVATE.EEF"

        # Public Templates
        self.TEMPLATE_PDTQKL_JPG = "LANDSAT8_MUSCATE/Templates/L2.product/DEFAULT_QKL_ALL.jpg"

        # GLOBAL
        self.TEMPLATE_GLOBAL_HDR = "LANDSAT8_MUSCATE/Templates/L2.product/MTD_ALL.xml"
        self.MAJA_INSTALL_SCHEMAS_L2_DIR = "LANDSAT8_MUSCATE/PSC-SL-411-0032-CG_Schemas"
