...
def test(argv):
    ...
    maja_object = MajaVenusMuscateL1ImageInformations()

    maja_object.initialize(argv[1], validate=False, schema_path=None)
    ...
    with open(os.path.join(argv[2],'VenusMuscate_mtd_l1_reader_file.json'), 'w') as file:
