...
function(install_rule src_file)
  ...
  foreach(sfile ${src_file_star})
    ...
    set(install_type)
    set(install_dir)
    if(IS_DIRECTORY ${sfile_ABS})
      message(STATUS "SKIP INSTALL of directory ${sfile_ABS}")
      continue()
    elseif ("${sfile_NAME_LOWER}" MATCHES "(test|tests|tests([0-9]+)|test([0-9])+)$" )
      if(FOR_VALIDATION)
	...
	if (install_type STREQUAL "SCRIPTS")
	  set(install_type PROGRAMS)
	endif()
      endif(UNIX)
    endif()
