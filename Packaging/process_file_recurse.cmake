...
function(process_file_recurse input_file)
  ...
  set(file_type)
  set(file_dest_dir)
  detect_using_file_command(${input_file_full_path} file_type file_dest_dir)
  if( "${file_type}" STREQUAL "SCRIPTS")
    #message(FATAL_ERROR "'${input_file_full_path}' ftype=${file_type}")
    return()
  endif()
