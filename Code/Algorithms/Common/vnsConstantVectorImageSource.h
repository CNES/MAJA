 ...
 *                                                                                                          *
 ************************************************************************************************************/
#ifndef __vnsConstantVectorImageSource_h
#define __vnsConstantVectorImageSource_h
...
namespace vns
{
    ...
    /** \class ConstantVectorImageSource
     * \brief Generate an n-dimensional multi-band image of specifics pixel values.
     *
     * ConstantVectorImageSource generates an multi-band image of specific pixel values.
     *
     * \ingroup DataSources Multithreaded
     */
    template<typename TOutputImage>
        class ConstantVectorImageSource : public itk::ImageSource<TOutputImage>
        {
        public:
            /** Standard class typedefs. */
            typedef ConstantVectorImageSource Self;
            ...
            itkTypeMacro(ConstantVectorImageSource,ImageSource)
            ...
            itkSetMacro(ConstantValue, OutputImagePixelType)
        ...
        private:
            ConstantVectorImageSource(const ConstantVectorImageSource&); //purposely not implemented
            void
            operator=(const ConstantVectorImageSource&); //purposely not implemented
...
#include "vnsConstantVectorImageSource.txx"
#endif

#endif // __vnsConstantVectorImageSource_h
