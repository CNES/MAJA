 ...
 *                                                                                                          *
 ************************************************************************************************************/
#ifndef __vnsSupOrEqualThresholdImageFunctor_h
#define __vnsSupOrEqualThresholdImageFunctor_h

namespace vns
{
    /** \class  SupOrEqualThresholdImageFunctor
    ...
    namespace Functor
    {
        template<class TInputPixel, class TOutputPixel>
            ...
            {
            public:
                typedef SupOrEqualThresholdImageFunctor<TInputPixel, TOutputPixel>
                        SupOrEqualThresholdImageFunctorType;

                SupOrEqualThresholdImageFunctor()
                {
                ...
                virtual ~SupOrEqualThresholdImageFunctor()
                {
                }
...
#endif /* __vnsSupOrEqualThresholdImageFunctor_h */
