 ...
 * FIN-HISTORIQUE                                                                                           *
 *                                                                                                          *
 * $Id: vnsFastVectorLinearInterpolateImageFunction.txx 10478 2015-06-17 16:12:13Z tfeuvrie $
 *                                                                                                          *
 ************************************************************************************************************/
#ifndef __vnsFastVectorLinearInterpolateImageFunction_txx
#define __vnsFastVectorLinearInterpolateImageFunction_txx
...
namespace vns
{
    ...
    template<class TInputImage, class TCoordRep>
        const unsigned long FastVectorLinearInterpolateImageFunction<TInputImage, TCoordRep>::m_Neighbors = 1
                << TInputImage::ImageDimension;

    // Constructor
    template<class TInputImage, class TCoordRep>
        FastVectorLinearInterpolateImageFunction<TInputImage, TCoordRep>::FastVectorLinearInterpolateImageFunction()
        {
    ...
    template<class TInputImage, class TCoordRep>
        void
        FastVectorLinearInterpolateImageFunction<TInputImage, TCoordRep>::PrintSelf(std::ostream& os,
    ...
    template<class TInputImage, class TCoordRep>
        typename FastVectorLinearInterpolateImageFunction<TInputImage, TCoordRep>::OutputType
        FastVectorLinearInterpolateImageFunction<TInputImage, TCoordRep>::EvaluateAtContinuousIndex(
