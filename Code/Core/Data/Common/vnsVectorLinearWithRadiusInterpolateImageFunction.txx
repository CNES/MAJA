 ...
 * FIN-HISTORIQUE                                                                                           *
 *                                                                                                          *
 * $Id: vnsVectorLinearWithRadiusInterpolateImageFunction.txx 10478 2015-06-17 16:12:13Z tfeuvrie $
 *                                                                                                          *
 ************************************************************************************************************/
#ifndef __vnsVectorLinearWithRadiusInterpolateImageFunction_txx
#define __vnsVectorLinearWithRadiusInterpolateImageFunction_txx

#include "vnsVectorLinearWithRadiusInterpolateImageFunction.h"
...
//        const unsigned long VectorLinearWithRadiusInterpolateImageFunction<TInputImage, TCoordRep>::m_Neighbors = 1
//                << TInputImage::ImageDimension;

    // Constructor
    template<class TInputImage, class TCoordRep>
        VectorLinearWithRadiusInterpolateImageFunction<TInputImage, TCoordRep>::VectorLinearWithRadiusInterpolateImageFunction()
        {
    ...
    template<class TInputImage, class TCoordRep>
        void
        VectorLinearWithRadiusInterpolateImageFunction<TInputImage, TCoordRep>::PrintSelf(std::ostream& os,
    ...
    template<class TInputImage, class TCoordRep>
        typename VectorLinearWithRadiusInterpolateImageFunction<TInputImage, TCoordRep>::OutputType
        VectorLinearWithRadiusInterpolateImageFunction<TInputImage, TCoordRep>::EvaluateAtContinuousIndex(
                const ContinuousIndexType& index) const
        {
            unsigned int dim; // index over dimension

            unsigned long l_Neighbors = m_Radius << TInputImage::ImageDimension;

//            vnsLogDebugMacro("VectorLinearWithRadiusInterpolateImageFunction : radius : <"<<m_Radius<<"> -> l_Neighbors = "<<l_Neighbors )
            ...
            double overlap(0.); // fraction overlap
            unsigned int upper(0); // each bit indicates upper/lower neighbour
            IndexType neighIndex;
            for (unsigned int counter = 0; counter < l_Neighbors; counter++)
            {
                overlap = 1.;
