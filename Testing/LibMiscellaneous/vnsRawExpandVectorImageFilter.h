 ...
 * FIN-HISTORIQUE                                                                                           *
 *                                                                                                          *
 * $Id: vnsRawExpandVectorImageFilter.h 2656 2011-02-15 10:25:38Z cvallade $
 *                                                                                                          *
 ************************************************************************************************************/

#ifndef __vnsRawExpandVectorImageFilter_h
#define __vnsRawExpandVectorImageFilter_h
...
/** \class RawExpandVectorImageFilter
 * \brief Expand the size of an image by an integer factor in each
 * dimension.
 *
 * RawExpandVectorImageFilter increases the size of an image by an integer
 ...
 * For vector images use VectorRawExpandVectorImageFilter.
 *
 ...
 * \sa VectorRawExpandVectorImageFilter
 *
 * \ingroup GeometricTransform
 */

template <class TInputImage, class TOutputImage>
class RawExpandVectorImageFilter : public itk::ImageToImageFilter<TInputImage,TOutputImage>
{
public:
    /** Standard class typedefs. */
    typedef RawExpandVectorImageFilter Self;
    ...
    itkTypeMacro(RawExpandVectorImageFilter, itk::ImageToImageFilter);
    ...
    /** RawExpandVectorImageFilter produces an image which is a different resolution and
     * with a different pixel spacing than its input image.  As such,
     * RawExpandVectorImageFilter needs to provide an implementation for
     * UpdateOutputInformation() in order to inform the pipeline execution model.
     * The original documentation of this method is below.
     * \sa ProcessObject::GenerateOutputInformaton() */
    virtual void GenerateOutputInformation();

    /** RawExpandVectorImageFilter needs a smaller input requested region than the output
...
protected:
    RawExpandVectorImageFilter();
    virtual ~RawExpandVectorImageFilter()
    {}
    void PrintSelf(std::ostream& os, itk::Indent indent) const;

    /** RawExpandVectorImageFilter is implemented as a multithreaded filter.  Therefore,
...
private:
    RawExpandVectorImageFilter(const Self&); //purposely not implemented
...
#include "vnsRawExpandVectorImageFilter.txx"
#endif
