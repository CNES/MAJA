...
int vnsShadowVariationThresholdImageFilterNew(int /*argc*/, char * /*argv*/ [])
{
    ...
    typedef vns::ShadowVariationThresholdImageFilter<InputImageType,InputMaskType,OutputMaskType>  FilterType;
