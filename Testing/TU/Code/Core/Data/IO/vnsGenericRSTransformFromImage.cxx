...
int vnsGenericRSTransformFromImage(int itkNotUsed(argc), char* argv[])
{
  /*
...
int vnsGenericRSTransformImageAndMNTToWGS84ConversionChecking(int itkNotUsed(argc), char* argv[])
{
