...
int vnsLookUpTableLUT3( int /*argc*/, char * argv[] )
{
    std::cout << "Testing vns::LookUpTable with values" << std::endl;

    // Configure Logger
    vns::Loggers::GetInstance()->Initialize(argv[0]);
    vns::Loggers::GetInstance()->SetMinLevel(vns::LoggerBase::DEBUG);

    typedef vns::LookUpTable<double, 3> LUTType;
    ...
    if (vcl_abs(getValues[2].ParameterValues[2] - 60.0) > 1e-4)
    {
        return EXIT_FAILURE;
    }
